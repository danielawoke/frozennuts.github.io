...
//the object part
{
  var grid = "<div id ='wrapper'><div id='grid'><div>";
  ...
  for(let i = 0; i<4;i++){
    ...
    if(width<4){
      for(let k = 0; k<4; k++){
      if(i == 0){
          grid = grid+"<div id='gridBlock"+y+"u"+x+"'><style>#gridBlock"+y+"u"+x+"{position: relative;display: inline;background-color: pink;border: 2px solid grey;padding-top: 10px;padding-left: 10px;padding-right: 30px;padding-bottom: 10px;}</style></div>";
          x=x+1;
      }else{
          grid = grid+"<div id='gridBlock"+y+"u"+x+"'><style>#gridBlock"+y+"u"+x+"{position: relative;display: inline;background-color: pink;border: 2px solid grey;padding-top: 10px;padding-left: 10px;padding-right: 30px;padding-bottom: 10px;}</style></div>";
          x=x+1;
    ...
    for(let k = 0; k<width; k++){
      ...
      grid = grid+"</div><div id='spaz'><style>#spaz{margin-top:20px;}</style>";
      y=y+1;
      x=0;
    }
  ...
  for(let i = 0; i<length;i++){
    for(let k = 0; k<width; k++){
            grid = grid+"<div id='gridBlock"+y+"u"+x+"'><style>#gridBlock"+y+"u"+x+"{position: relative;display: inline;background-color: black;border: 2px solid grey;padding-top: 10px;padding-left: 10px;padding-right: 30px;padding-bottom: 10px;}</style></div>";
            x=x+1;
    }
    y=y+1;
    x=0;
